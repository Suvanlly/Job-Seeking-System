...
public class CandidatesController implements Initializable{
    ...
    public void initialize(URL location, ResourceBundle resources){
                ...
                while(resultSetApp.next()){
                    ...
                    button.setOnAction(new EventHandler<ActionEvent>() {
                        ...
                        public void handle(ActionEvent actionEvent) {
                            ...
                            labelAppDob.setText(String.valueOf(dob));
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                if (m.find()){
                    ...
                    try{
                        ...
                        messageController.setJobInfo(labelAppJob.getText().replaceAll("Applied To: ", ""));
                        messageController.setUserInfo(labelAppUsername.getText().replaceAll("@", ""));
        ...
        buttonReject.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
                UpdateUtility.candidateUp(labelAppUsername.getText().replaceAll("@", ""), user_id, labelAppJob.getText().replaceAll("Applied To: ", ""), false, false);
                buttonInvite.setDisable(true);
                buttonReject.setDisable(true);
            }
        });
