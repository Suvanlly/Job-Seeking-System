...
public class JobsCreateController implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resources) {
        ...
        buttonJobPublish.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
                JobsUtility.createJob(user_id, tfJobTitle.getText(), tfCompanyName.getText(), tfJobLocation.getText(), Integer.parseInt(tfJobSalary.getText()), tfJobContent.getText(), true, tfJobSkills.getText(), tfJobCategory.getText());
                ((Stage) buttonJobCancel.getScene().getWindow()).close();
            }
        });
        ...
        buttonJobSave.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
                JobsUtility.createJob(user_id, tfJobTitle.getText(), tfCompanyName.getText(), tfJobLocation.getText(), Integer.parseInt(tfJobSalary.getText()), tfJobContent.getText(), false, tfJobSkills.getText(), tfJobCategory.getText());
                ((Stage) buttonJobCancel.getScene().getWindow()).close();
            }
        });
    }
