...
public class DashboardController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources){
        ...
        PreparedStatement preparedStatement; //used to query
        ResultSet resultSet; //holds the results
        PreparedStatement preparedStatementSender;
        ResultSet resultSetSender;
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                if (m.find()){
                    ...
                    try{
                        ...
                        messageController.setMessageType(1);
