    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        buttonNewJob.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                try{
                    ...
                    stg.setScene(scene);
                    JobsCreateController jobsCreateController = loader.getController();
                    jobsCreateController.setTfJobLocation(jobLocation);
                    jobsCreateController.setTfCompanyName(companyName);
                    stg.show();
                }
                catch(IOException e){
                    e.printStackTrace();
        ...
        buttonPublish.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                {
                    UpdateUtility.jobVisibilityUp(user_id, tfJobTitle.getText(), true);

                    buttonPublish.setText("Unpublish");
                    buttonUpdateJob.setDisable(true);
                }
                else {
                    UpdateUtility.jobVisibilityUp(user_id, tfJobTitle.getText(), false);
        ...
        buttonUpdateJob.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
                UpdateUtility.jobUp(tfJobTitle.getText(), tfJobLocation.getText(), tfJobSalary.getText(), tfJobContent.getText(), user_id, getCurrentTitle());
                UpdateUtility.skillJobUp(user_id, tfJobSkills.getText(), getCurrentTitle());//update display text, refresh fxml ?
